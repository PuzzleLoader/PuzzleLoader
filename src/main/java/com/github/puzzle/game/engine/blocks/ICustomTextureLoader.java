...
public interface ICustomTextureLoader {
    ...
    ICustomTextureLoader INSTANCE = Constants.SIDE == EnvType.CLIENT ? (ICustomTextureLoader) Reflection.newInstance("com.github.puzzle.game.engine.blocks.CustomTextureLoader") : new ICustomTextureLoader() {
        @Override
