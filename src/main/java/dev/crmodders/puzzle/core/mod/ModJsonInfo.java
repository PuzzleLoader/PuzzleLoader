...
public record ModJsonInfo(
    ...
    public static class ModInfoBuilder {
        ...
        static Map<String, String> TransformDepencenciesMap(Map<String, Version> dependencies) {
    ...
    public static ModInfoBuilder builder() {
        return new ModInfoBuilder();
    }

    public ModContainer createModContainer() {
