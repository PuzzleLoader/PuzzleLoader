        ...
        while((ln = reader.readLine())!=null){
            ...
            switch (access){
                ...
                case "protected":
                    ...
                    break;
                default:
                    throw new RuntimeException("Unsupported access: '" + tokens.get(0) + "'");
            }
            ...
            switch (type) {
                ...
                case "field":
                    if (tokens.size()==4) {
                        ...
                        hm.put(tokens.get(2),new FieldModifierPair(tokens.get(3), tokens.get(2), modifier));
                        AccessManipulatorTransformer.fieldsToModify.put(tokens.get(3), hm);
                    }
                    else
