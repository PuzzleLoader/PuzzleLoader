...
import net.appel.mixin.LaunchWrapperMixinService;
...
public class Launch {
//    private static final String DEFAULT_TWEAK = "net.appel.tweakers.CosmicReachClientTweaker";
    ...
    private Launch() {
        ...
        if (Main.searchForCosmicReach() != null) {
            try {
                urls.add(Main.searchForCosmicReach().file().toURL());
            } catch (MalformedURLException e) {
