...
import io.github.puzzle.game.engine.stages.Initialize;
import io.github.puzzle.game.engine.stages.LoadingAssets;
import io.github.puzzle.game.engine.stages.LoadingCosmicReach;
import io.github.puzzle.game.engine.stages.PostInitialize;
import io.github.puzzle.game.events.OnPreLoadAssetsEvent;
import io.github.puzzle.game.ui.CosmicReachFont;
import io.github.puzzle.game.ui.TranslationParameters;
...
import static io.github.puzzle.core.PuzzleRegistries.EVENT_BUS;
import static io.github.puzzle.core.resources.PuzzleGameAssetLoader.LOADER;
...
//        puzzleIcon = LOADER.loadSync("puzzle-loader:icons/PuzzleLoaderIconx128.png", Texture.class);
    ...
    public void render() {
        ...
        if(Globals.GameLoaderHasLoaded) {
