...
public interface IModBlock {
     ...
     */
    default void onInteract(Zone zone, BlockState blockState, BlockPosition position) {}
     ...
     * @param position The Blocks Position
     */
    default void onPlace(Zone zone, BlockState blockState, BlockPosition position) {
     ...
     * @param position The Blocks Position
     */
    default void onBreak(Zone zone, BlockState blockState, BlockPosition position) {
    ...
    default List<IBlockModelGenerator> getBlockModelGenerators(Identifier blockId) {
        if (Constants.SIDE == Environment.CLIENT) {
